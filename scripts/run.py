...
from fedmaq.core.models import get_model, get_model_parameters, set_model_parameters
...
def main(cfg: DictConfig) -> None:
    ...
    def client_fn(context: fl.app.Context) -> fl.client.Client:
        ...
        # Determine compressor hook based on algorithm (Phase 1 uses standard identity)
